...
#for image in B*LD*.jpg; do convert $image -quality 80 $image; done
#for image in *.jpg; do convert $image -resize x820 $image; done
#convert KING.0004.jpg -resize x3240 KING.0003.jpg

#for image in *.webp do convert $image -quality 75 $image; done
for image in *.webp; do convert $image -quality 75 $image; done
