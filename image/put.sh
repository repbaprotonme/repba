...
#curl --request POST $POST  --header "$HEADER" --form $IMAGE --form $ID --form 'metadata={"key":"value","width":"100","email":"reportbase@gmail.com"}'
curl --request POST $POST  --header "$HEADER" --form $IMAGE --form 'metadata={"key":"value"}'
